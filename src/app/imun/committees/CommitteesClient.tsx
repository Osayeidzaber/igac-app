...
export default function CommitteesClient({ settings }: { settings: SiteSettingsPublic }) {
    return (
            ...
            <div className="container relative z-10 mx-auto px-6 max-w-5xl pt-10">
                ...
                <div className="text-center mb-24 relative">
                    ...
                    <Reveal delay={0.2} width="100%">
                        <h1 className="font-primary text-5xl md:text-7xl lg:text-[6rem] leading-[1.1] text-white uppercase tracking-widest mb-6">
                            ...
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#f2c45f] via-[#ffd97d] to-[#b38e36] italic font-decorative tracking-normal pr-4 lowercase drop-shadow-lg">Committees</span>
                        </h1>
                    </Reveal>
                    <Reveal delay={0.3} width="100%">
                        <p className="text-neutral-400 font-secondary text-lg md:text-xl leading-relaxed max-w-2xl mx-auto">
                            The arenas of debate and diplomacy at Imperial Model United Nations.
                        </p>
                    </Reveal>
                </div>
                <motion.div 
                ...
                >
                    ...
                    <p className="font-secondary text-neutral-400 text-lg leading-relaxed max-w-lg mx-auto relative z-10">
                        The definitive list of Committees and their respective Agendas are heavily guarded and have not yet been revealed to the public. 
                        <br/><br/>
                        Stay tuned to our official portals for the great unveiling.
                    </p>
                    {settings.imun_committees_timer && (
                        <div className="mt-8">
                            <CountdownTimer targetDateStr={settings.imun_committees_timer} label="Agendas Classified Until" secret={true} />
                        </div>
                    )}
                </motion.div>
            </div>
